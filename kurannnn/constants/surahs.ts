...
export interface Ayah {
  ...
  footnotes?: Footnote[]; // Dipnotları içeren yeni alan
}

// Bu kısım, uygulamanızdaki mevcut sure listesini temsil eder.
// Eğer bu dosya daha önce yoksa veya içeriği farklıysa, lütfen mevcut yapınıza göre ayarlayın.
// Örnek bir SURAHS dizisi:
export const SURAHS: Surah[] = [
  { id: 1, name: "Fatiha", arabicName: "الفاتحة", verseCount: 7 },
  ...
  { id: 14, name: "İbrâhîm", arabicName: "ابراهيم", verseCount: 52 },
  ...
  { id: 40, name: "Mü'min", arabicName: "المؤمن", verseCount: 85 },
  ...
  { id: 56, name: "Vâkı'a", arabicName: "الواقعة", verseCount: 96 },
  ...
  { id: 62, name: "Cum'a", arabicName: "الجمعة", verseCount: 11 },
  { id: 63, name: "Münâfikûn", arabicName: "المنافقون", verseCount: 11 },
  { id: 64, name: "Tegâbun", arabicName: "التغابن", verseCount: 18 },
  ...
  { id: 70, name: "Me'âric", arabicName: "المعارج", verseCount: 44 },
  { id: 71, name: "Nûh", arabicName: "نوح", verseCount: 28 },
  { id: 72, name: "Cinn", arabicName: "الجن", verseCount: 28 },
  { id: 73, name: "Müzzemmil", arabicName: "المزمل", verseCount: 20 },
  { id: 74, name: "Müddessir", arabicName: "المدثر", verseCount: 56 },
  { id: 75, name: "Kıyâmet", arabicName: "القيامة", verseCount: 40 },
  { id: 76, name: "İnsân", arabicName: "الإنسان", verseCount: 31 },
  { id: 77, name: "Mürselât", arabicName: "المرسلات", verseCount: 50 },
  { id: 78, name: "Nebe'", arabicName: "النبأ", verseCount: 40 },
  { id: 79, name: "Nâzi'ât", arabicName: "النازعات", verseCount: 46 },
  ...
  { id: 94, name: "İnşirâh", arabicName: "الإنشراح", verseCount: 8 },
  { id: 95, name: "Tîn", arabicName: "التين", verseCount: 8 },
  { id: 96, name: "Alak", arabicName: "العلق", verseCount: 19 },
  { id: 97, name: "Kadr", arabicName: "القدر", verseCount: 5 },
  ...
  { id: 101, name: "Kâri'a", arabicName: "القارعة", verseCount: 11 },
  ...
  { id: 107, name: "Mâ'ûn", arabicName: "الماعون", verseCount: 7 },
  ...
  { id: 111, name: "Mesed", arabicName: "المسد", verseCount: 5 },
